...
const _Button = React.forwardRef((props, ref) => <TouchableOpacity
  ...
  }, props.style]}><Text style={[{  }, props.textStyle]}>{props.children}</Text></TouchableOpacity>);


const Button = React.forwardRef((props, ref) => {
  const { alignSelf, style, outline, fontSize = 16, p, pt, pb, pl, pr, pv, ph, h = 46, w, m, mt, mb, ml, mr, mv, mh, color, bgcolor, border = [], flexGrow, flex } = props;
  return (
    !outline ?
      <_Button
        ref={ref}
