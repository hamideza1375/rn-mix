            ...
            <View style={{ flex: 1 }}>
              <Animated.View style={[styles.viewInput, { minHeight: 90 }, { marginBottom: 5 }]} >
                ...
                >
                  ...
                  <View style={{position:'absolute', height:'100%', width:'14.8%', right:0,borderLeftWidth:.8,borderColor:'#111',alignItems:'center', justifyContent:'center'}} >
                   <Icon style={{}} name={'image'} size={22} color={"#666"} />
                   </View>
                   <Text style={{position:'absolute', width:'85%', left:0, paddingRight:5}} >انتخواب عکس از گالری</Text>
                    <input
                    type={'file'}
                    placeholder=" انتخاب از گالری "
                      onChange={(event)=>{console.log(event.target.files[0]);setImageUrl(event.target.files[0])}}
